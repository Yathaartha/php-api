<?php
  ...
  class UserModel extends Database {
    public function addUser($firstname, $lastname, $username, $address, $phone, $email, $password){
      ...
      return $this->insert("INSERT INTO CUSTOMER VALUES (null, :firstname, :lastname, :username, :address, :phone, :email, :password, 'http://localhost:1000/php-api/assets/images/dummy-profile.png', 'inactive' )", $firstname, $lastname, $username, $address, $phone, $email, $password);
    ...
    public function getToken($username, $password){
      ...
      return $this->login("SELECT * FROM CUSTOMER WHERE USERNAME = :username AND PASSWORD = :password", $username, $password);
    }
